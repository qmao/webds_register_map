...
export const RegisterData = (props: IProps): JSX.Element => {
    ...
    useEffect(() => {
        ...
        console.log('Register Data view', props.row);
    }, [props.row]);
    ...
    function disaplyBits() {
        ...
        function updateBitValue(event: any, position: string, value: any) {
            let start: any;
            let end: any;
        ...
        function onEditDone(event: any, value: any, row: any) {
            if (props.row.value === undefined) {
                console.log('Undefined value. Please update register value.');
                return;
            }
            if (updateBitValue(event, row.position, value)) {
                setEditMode(false);
            }
        }
                                        ...
                                        >
                                            ...
                                            {editMode === true && (
                                                <Input
                                                    ...
                                                    onBlur={(e) =>
                                                        onEditDone(e, e.currentTarget.value, row)
                                                    }
